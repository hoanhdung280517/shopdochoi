					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="fk-boxs" id="km-all" data-comt="False">
								<div id="km-detail">
									<p class="fk-tit">Khuyến mại đặc biệt khi mua hàng (SL có hạn)</p>
									<div class="fk-main">
									  <div class="fk-sales">
											</ul>
											<ul>
												<li>Miễn phí giao hàng cho các đơn hàng từ 1,000,000đ trở lên. </li>
											</ul>
											<ul>
												<li>Giảm giá 5% khi khách đặt hàng Online trên trang website. </li>
											</ul>
											<ul>
												<li>Giảm thêm 300,000đ khi mua combo 3 sản phẩm trên 1 hoá đơn.</li>
											</ul>
										</div>
									</div>
								</div>
						  ...
						  <div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
							  <span>Nguyên hộp(thùng), sản phẩm mới 100%. </span>							</div>
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								Đổi trả hàng khi phát hiện lỗi từ nhà sản xuất.
